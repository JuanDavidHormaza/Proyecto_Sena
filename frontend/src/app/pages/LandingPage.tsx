            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full overflow-hidden flex items-center justify-center shadow-lg shadow-slate-900/15">
                    <img src="/worklex.png" alt="WorkLex" className="h-10 w-10 object-cover" />
                  </div>
                  <div>
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="w-12 h-12 rounded-full overflow-hidden flex items-center justify-center mb-3 shadow-lg shadow-slate-900/15">
                  <img src="/worklex.png" alt="WorkLex" className="h-9 w-9 object-cover" />
                </div>
              ...
              >
                <div className="w-12 h-12 bg-warning/10 rounded-xl flex items-center justify-center mb-3">
                  <img src="/worklex.png" alt="WorkLex" className="h-9 w-9 object-contain" />
                </div>
                <p className="text-2xl font-bold text-foreground">0%</p>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="mx-auto mb-6 h-20 w-20 rounded-full overflow-hidden bg-white p-2 shadow-lg shadow-slate-900/15">
      ...
      <footer className="py-8 px-6 border-t border-border bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden border border-border shadow-lg shadow-slate-900/10">
                <img src="/worklex.png" alt="WorkLex" className="w-full h-full object-cover" />
              </div>
              <div>
